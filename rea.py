...
class REA(object):
    ...
    def __init__(self, filename, skiprows=1, only_valid=True):
        ...
        self.signal = numpy.loadtxt(filename, skiprows=skiprows, usecols=(1,), dtype=numpy.int16)
        ...
        if only_valid:
            ...
            self.signal = numpy.compress(flag == False, self.signal, axis=0)
